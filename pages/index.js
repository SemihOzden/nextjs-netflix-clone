...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-black  bg-no-repeat"
    style={{
        'backgroundImage':
          'linear-gradient(rgb(0 0 0 / 60%), rgb(0 0 0 / 60%)), url(https://assets.nflxext.com/ffe/siteui/vlv3/b77751c7-0e02-4941-af39-30514ff6b3e2/d9ff5a71-2080-4b2d-aec8-6976c3a38093/TR-en-20211026-popsignuptwoweeks-perspective_alpha_website_small.jpg',
      }}
    >
      <Head>
      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center ">
        ...
        <div className="flex mt-4">
          ...
          <button onClick={() => signIn('google')} className="bg-red-500 text-white text-xl px-8 flex items-center">
            Get Started
            <svg
